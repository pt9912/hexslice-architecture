...
| --- | --- | --- |
| [Go](examples/go/) | Create Order, Cancel Order | Two vertical slices, all three port scopes, CLI inbound adapter, in-memory/id/notify outbound adapters, `make` + Docker, [a-check](https://github.com/pt9912/a-check) architecture gate |
